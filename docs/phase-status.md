# Phase status & module map (historical)

> Moved from the README on 2026-07-11 — the phase-by-phase build record, module layout
> and acceptance summaries. For orientation start with the [README](../README.md),
> [how-it-works.md](how-it-works.md) (plain language) or [theory.md](theory.md) (technical).
