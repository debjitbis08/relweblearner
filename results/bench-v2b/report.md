...
5 seeds, ~509 pages and 23 queries each; 1s total. Pre-registered design and predictions: docs/falsification-plan.md (written before this run).
...
| F4-invert-skip | 0.00 +/- 0.00 | 1.00 +/- 0.00 | 1.00 +/- 0.00 | 1.00 +/- 0.00 | 0.00 +/- 0.00 |
